...
public record ParagraphDto(int Id, int ChapterId, int Index, string Text, string? LongfellowText, string? DeeplText, string? RefinedText, string? UkrainianText, string? LineTransJson);
